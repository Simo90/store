        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div>
                        <form method="POST" action="{{ url( config('app.admincp') . '/products/' . $product->id ) }}" accept-charset="UTF-8" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div style="width:100px;margin-top:6px;">
                                    <a href="{{ url( '/storage/'.$product->image ) }}" target="_blank">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="exampleInputPassword1" name="description">{{ $product->description }}</textarea>
                            </div>
